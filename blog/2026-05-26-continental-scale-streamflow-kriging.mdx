...
<figure style={{ textAlign: "center" }}>
  <img
    src={useBaseUrl('/img/blog/2026-05-kriging/kriging-streamflow-variogram.gif')}
    width='80%'
    alt="Animated hourly kriged streamflow and variogram fields across CONUS from the NextGen Research Data Stream."
  />
  <figcaption><em>Figure 1: Hourly kriged streamflow and variogram for the CONUS region, accessed from the <a href="https://ciroh-community-ngen-datastream.s3.amazonaws.com/status/dashboard.html">NextGen Research Data Stream</a>.</em></figcaption>
</figure>
...
<figure style={{ textAlign: "center" }}>
  <img
    src={useBaseUrl('/img/blog/2026-05-kriging/t-route-south-toe.png')}
    width='80%'
    alt="T-route streamflow simulation initialized with held-out kriged runoff in the South Toe River hydrofabric, compared against USGS observations during Hurricane Helene."
  />
  <figcaption><em>Figure 2: T-route simulation of streamflow initialized using held-out kriged runoff in the NextGen hydrofabric of the South Toe River.</em></figcaption>
</figure>
